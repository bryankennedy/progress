# Progress — Product Spec & Roadmap (v1, archived)

> **Archived 2026-06-17 — a frozen artifact of v1's development.** Every item
> here shipped and was dogfooded; this is the completed v1 roadmap (the
> product-development tracker). The **active** roadmap is
> [`../SPEC.md`](../SPEC.md) (v2). This document is kept unchanged for
> traceability: code comments and `DECISIONS.md` entries written during v1 cite
> these section numbers (e.g. `SPEC §8.2`, `SPEC §11.1`), so they resolve here.
>
> ---
>
